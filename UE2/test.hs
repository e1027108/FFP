...
-- super ugly version.. this calculates way too much stuff that just gets filtered out anyways.
-- TODO: omit gen_all, modify gen single? 
-- FACT: [1,2,3] => [[1],[2],[3],[1,1],..,[1],[2],[3],..] lower parts are re-calculated in every iteration!
gen_turns :: Dartboard -> Turns
gen_turns d = removeDupl (concat (map (gen_all d [] [] 1) [1..]))

-- executes gen_single for all sub list lengths (e.g. [1,2,3] -> [1], [1,2], [1,2,3]
gen_all :: Dartboard -> Turns -> Turns -> Int -> Int -> Turns
...
gen_single :: Dartboard -> Turns -> Turns -> Int -> Turns
